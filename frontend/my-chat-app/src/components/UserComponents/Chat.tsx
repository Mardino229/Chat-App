...
export default function Chat () {
    ...
    return (
        <>
            {
                !id ? <div className="items-center  h-screen flex-col hidden w-full lg:flex mx-auto sm:ml-64">
                                <Logo size="h-32 w-32 h-full"/>
                    </div> :
                    <div className=" flex-col sm:ml-64 h-full hidden lg:flex overflow-x-auto mb-1 mt-14">
